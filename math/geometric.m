% geometric solution for striker
...
% It would be a fun exercise to determine what all these are based on goal position and constants
% Maybe not for right now tho?